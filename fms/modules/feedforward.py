...
class FeedForwardBlock(nn.Module):
    ...
    #def to_cp(self, group: ProcessGroup) -> "CPFeedForwardBlock":
    #    return CPFeedForwardBlock.import_module(self, group)
...
#class CPFeedForwardBlock(FeedForwardBlock, CPModule):
#    """
#    A two-layer, symmetric, fully-connected MLP structure with Context Parallel support.
#
#    Args
#    ----
#    Check FeedForwardBlock for up-to-date docs
...
class GatedLinearUnit(nn.Module):
    ...
    #def to_cp(self, group: ProcessGroup) -> "CPGatedLinearUnit":
    #    return CPGatedLinearUnit.import_module(self, group)
...
#class CPGatedLinearUnit(GatedLinearUnit, CPModule):
#    """
#    A two-point-five-layer, fully-connected gated linear MLP structure (GLU).
#    Contains 50% extra params compared to FeedForwardBlock, adjust accordingly.
#    This subclass adds Context Parallel support.
#
#    Args
#    ----
#    Check GatedLinearUnit for up-to-date docs
...
#
#    @staticmethod
#    def import_module(glu: GatedLinearUnit, group: ProcessGroup) -> "CPGatedLinearUnit":
#        cp_glu = CPGatedLinearUnit(
#            emb_dim=glu.width,
#            hidden_grow_factor=glu.hidden_dim / glu.width,
#            multiple_of=None,
#            activation_fn=glu.a,
...
class ConditionalFeedForward(nn.Module):
    ...
    #def to_cp(self, group: ProcessGroup) -> "CPConditionalFeedForward":
    #    return CPConditionalFeedForward.import_module(self, group)
...
#class CPConditionalFeedForward(ConditionalFeedForward, CPModule):
#    """
#    This class represents the expert feed forward networks of an MoE FF layer.
#    This subclass adds CP support.
#
#    Args
#    ----
#    num_experts : int
...
#    def import_module(
#        cff: ConditionalFeedForward, group: ProcessGroup
#    ) -> "CPConditionalFeedForward":
#        cp_cff = CPConditionalFeedForward(
#            num_experts=cff.num_experts,
#            dim=cff.dim,
#            intermediate_size=cff.intermediate_size,
#            group=group,
